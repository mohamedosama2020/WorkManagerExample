...
public class BlurViewModel extends ViewModel {
    ...
    void applyBlur(int blurLevel) {
        ...
        WorkContinuation continuation =
                mWorkManager.beginUniqueWork(IMAGE_MANIPULATION_WORK_NAME,ExistingWorkPolicy.REPLACE,OneTimeWorkRequest
                        .from(CleanupWorker.class));
        ...
        for (int i = 0; i < blurLevel; i++) {
            ...
            // blur operations.
            OneTimeWorkRequest.Builder blur =
                    new OneTimeWorkRequest.Builder(BlurWorker.class);

            if(i ==0){
                blur.setInputData(createInputDataForUri());
            }
